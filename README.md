...
Testing repo is here: - [`demo-webapp`](https://github.com/Stanley29/demo-webapp).
...
├── project-03-linux-essentials/
├── project-04-git-github-wildfly/
├── project-05-jenkins-ci-cd/
├── project-06-jenkins-pipeline/
├── project-07-aws-cli-cloudformation-terraform/
├── project-08-terraform-ansible/
├── project-09-docker-basics/
├── project-10-docker-advanced/
├── project-11-gitlab-ci/
├── project-12-github-actions/
├── project-13-kubernetes-fundamentals/
├── project-14-kubernetes-eks/
├── project-15-helm-kustomize/
└── project-16-kubernetes-advanced/
```
...
- code, scripts, configs, or diagrams

- explanations of the approach and results
---
...
It reflects my progress through the Prog Academy DevOps program, transformed into **professional engineering projects**.
